-- Gkyl ------------------------------------------------------------------------
-- Z.Liu 4/11/2021
-- This input file is the first 2x2v simulation with 1. all modes excited 2. noise added 3. collision added
-- This is intended to be the standard IAT simulation setup with External E
-- Name was: IATwEext_2x2v_pert.lua
