...
perturbation = 1.0e-7 -- distribution function perturbation
...
plasmaApp = Plasma.App {
    ...
    ion = Plasma.Species {
       ...
       -- Velocity space grid.
       lower = {-16.0*vtIon,-8.0*vtIon},
       upper = {16.0*vtIon,8.0*vtIon},
       cells = {32,16},
       decompCuts = {1,1},
       -- Initial conditions.
       init = function (t, xn)
          ...
          local dfv = sponEmissionSource({x,y,vx,vy},t, lx, nx, pOrder)[1]
