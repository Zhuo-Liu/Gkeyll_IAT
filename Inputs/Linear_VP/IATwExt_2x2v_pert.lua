...
plasmaApp = Plasma.App {
    ...
    elc = Plasma.Species {
       ...
       init = function (t, xn)
          ...
          local dfv = sponEmissionSource({x,y,vx,vy},t, lx, nx, polyOrder)[2]*maxwellian2v({vx, vy}, vDriftElc, vtElc)
    ...
    ion = Plasma.Species {
       ...
       init = function (t, xn)
          ...
          local dfv = sponEmissionSource({x,y,vx,vy},t, lx, nx, polyOrder)[1]*maxwellian2v({vx,vy},vDriftIon, vtIon) 
