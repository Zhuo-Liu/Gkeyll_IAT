-- Gkyl ------------------------------------------------------------------------
-- Z.Liu 5/30/2021
-- This input file is modified from IAT_E2
-- This input file extended the electron velocity range, add collisions, use more cores
...
plasmaApp = Plasma.App {
    ...
    elc = Plasma.Species {
       charge = -1.0, mass = 1.0,
       -- Velocity space grid.
       lower = {-4.0*vtElc,-6.0*vtElc},
       upper = {11.0*vtElc,6.0*vtElc},
       cells = {120,96},
       decompCuts = {1,1},
       -- initial conditions
       init = function (t, xn)
