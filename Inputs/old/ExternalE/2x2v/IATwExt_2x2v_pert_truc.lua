-- Gkyl ------------------------------------------------------------------------
-- Z.Liu 4/22/2021
-- This input file is on basis of IATwExt_2x2v_pert.lua
-- This input file tried to use a truncated Maxwellian distribution function to let the simulation run longer
