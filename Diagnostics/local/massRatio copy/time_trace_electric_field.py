...
ax.plot(time_Iontemp1[:350],Elctemp1[0]/Iontemp1[:350],linewidth=5,color='blue',linestyle='-',label='E1')
...
# ax.plot(time_Elctemp1[:],Elctemp1[:]/Elctemp1[0],linewidth=5,color='blue',label=r'$E_{ext} = 10^{-5} $')
...
# ax.plot(time_Iontemp1[:],Iontemp1[:]/Iontemp1[0],linewidth=5,color='blue',label=r'$E_{ext} = 10^{-5} $')
