...
def theta_main(Ez_k_list,Ey_k_list, N=6):
    ...
    Ezk_500 = Ez_k_list[45,:,:]
    Eyk_500 = Ey_k_list[45,:,:]
    Ezk_750 = Ez_k_list[75,:,:]
    Eyk_750 = Ey_k_list[75,:,:]
    Ezk_1000 = Ez_k_list[85,:,:]
    Eyk_1000 = Ey_k_list[85,:,:]
    ...
    ax.plot(theta_plot,E_1000_f/E_1000_f[0],label=r'$\omega_{pe}t=1000$',linewidth=3,color=colors[1])
    ax.plot(theta_plot,E_2000_f/E_2000_f[0],label=r'$\omega_{pe}t=2000$',linewidth=3,color=colors[3])
    ax.plot(theta_plot,E_3500_f/E_3500_f[0],label=r'$\omega_{pe}t=3500$',linewidth=3,color=colors[4])
