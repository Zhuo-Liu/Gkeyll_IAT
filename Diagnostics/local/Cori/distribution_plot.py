...
def elc_main():
    df1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/4/dist_function/450.0_elc_1d.txt')
    ...
    df = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/4/dist_function/550.0_elc_1d.txt')
    ...
    plt.plot(velocities_z/0.02, df1,label=r'$\omega_{pe}t=450$ (before saturation)',linewidth=6)
    plt.plot(velocities_z/0.02, df,label=r'$\omega_{pe}t=500$ (after saturation)',linewidth=6)
    plt.plot(velocities_z/0.02, df2,label=r'$\omega_{pe}t=750$',linewidth=6)
    plt.plot(velocities_z/0.02, df3,label=r'$\omega_{pe}t=900$',linewidth=6)
    ...
    plt.plot(velocities_z/0.02, maxw1,linewidth=5,linestyle='--')
    plt.plot(velocities_z/0.02, maxw2,linewidth=5,linestyle='--',color='green')
    plt.plot(velocities_z/0.02, maxw3,linewidth=5,linestyle='--',color='red')
    plt.plot(velocities_z/0.02, df4,label=r'$\omega_{pe}t=1600$  ',linewidth=6)
...
def ion_main():
    ...
    df4 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/4/dist_function/750.0_ion_1d.txt')
    df5 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/4/dist_function/1600.0_ion_1d.txt')
    df6 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/4/dist_function/2400.0_ion_1d.txt')
    ...
    plt.plot(velocities_z/(0.004), df4,label=r'$\omega_{pe}t=750$',linewidth=6)
    plt.plot(velocities_z/(0.004), df5,label=r'$\omega_{pe}t=1600$',linewidth=6)
    plt.plot(velocities_z/(0.004), df6,label=r'$\omega_{pe}t=2400$',linewidth=6)
...
if __name__ == '__main__':
    ...
    #fit_1d_t('./Diagnostics/local/Cori/mass25/rescheck/4/dist_function/950.0_elc_1d.txt',ElcGridPath)
