...
fieldEnergy4 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/fieldEnergy.txt')
time_fieldEnergy4 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/fieldEnergy_time.txt')
fieldEnergy = np.loadtxt('./Diagnostics/local/Cori/mass25/temp200/saved_data/fieldEnergy.txt')
time_fieldEnergy= np.loadtxt('./Diagnostics/local/Cori/mass25/temp200/saved_data/fieldEnergy_time.txt')
Iontemp4 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/4/saved_data/ion_intM2Thermal.txt')*25
...
# ax.vlines(1100,0,6.0,linestyle='--',linewidth=2,color='black')
...
ax.plot(time_Elctemp4[151:400],Elctemp4[151:400]/Elctemp4[0],label='electron',linewidth=5,color='black',linestyle='-.')
ax.plot(time_Iontemp4[151:400],Iontemp4[151:400]/Iontemp4[0],label='ion',linewidth=5,color='black',linestyle='--')
#ax2.plot(time_Iontemp4[70:95],Elctemp4[70:95]/Iontemp4[70:95],linewidth=5,color='blue')
ax2.plot(time_Iontemp4[151:400],Elctemp4[151:400]/Iontemp4[151:400],linewidth=5,color='blue')
ax.set_xlabel(r'$t \quad [\omega_{pe}^-1]$',fontsize=32)
