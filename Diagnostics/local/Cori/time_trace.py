...
ax.set_ylabel(r'$\int |\delta E_z|^2 + |\delta E_y|^2  dydz$',fontsize=24,color='red')
...
# ax.plot(time_Elctemp4,Elctemp4/Elctemp4[0],label='electron',linewidth=5,color='black',linestyle='-.')
# ax.plot(time_Iontemp4,Iontemp4/Iontemp4[0],label='ion',linewidth=5,color='black',linestyle='--')
