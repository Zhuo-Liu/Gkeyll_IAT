...
def linear_theory():
    ...
    plt.savefig('./Linear_theory/temp50_gamma.pdf')
    plt.clf()
    ...
    ax.tick_params(labelsize = 18)
    ax.legend(fontsize=24)
    plt.savefig('./Linear_theory/temp50_omega.pdf')
    plt.clf()
    ...
    ax.set_xlim(0,)
    ax.set_xlabel(r'$k_z/2 \pi \quad  [\lambda_{De}^{-1}]$',fontsize=26)
    ax.set_ylabel('$\gamma/k \quad [\lambda_{De} \omega_{pe}]$',fontsize=26)
    ax.tick_params(labelsize = 18)
    ax.yaxis.offsetText.set_fontsize(16)
    ax.ticklabel_format(axis='y', style='sci', scilimits=(2,0))
    ax.legend(fontsize=24)
    plt.savefig('./Linear_theory/temp50_gammaoverk.pdf')
    plt.clf()
    ...
    ax.set_xlim(0,)
    ax.set_xlabel(r'$k_z/2 \pi \quad [\lambda_{De}^{-1}]$',fontsize=26)
    ax.set_ylabel('$\omega/k \quad [\omega_{pe} \lambda_{De}]$',fontsize=26)
    ax.tick_params(labelsize = 18)
    ax.yaxis.offsetText.set_fontsize(16)
    ax.ticklabel_format(axis='y', style='sci', scilimits=(2,0))
    ax.legend(fontsize=24)
    plt.savefig('./Linear_theory/temp50_omegaoverk.pdf')
    plt.clf()
...
def mass25():
    ...
    plt.ylabel('$\gamma/\omega_{pe}$',fontsize=46)
    plt.tick_params(labelsize = 32)
    plt.savefig('./Linear_theory/mass25/temp50_mass25_gamma_annotated.pdf')
    #plt.show()
    #plt.clf()
...
def eaw():
    ...
    ax2.set_ylim(0,1.2)
    ax2.set_ylabel(r'$v_{Te0}$',fontsize=26,color='blue')
    ax.tick_params(labelsize = 18)
