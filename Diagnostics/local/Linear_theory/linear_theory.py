...
def linear_theory():
    ...
    ax.plot(k_sample_25/2/np.pi,gamma_sample_25,linewidth=5,label='$m_i/m_e = 25$')
    ax.plot(k_sample_100/2/np.pi,gamma_sample_100,linewidth=5,label='$m_i/m_e = 100$')
    ax.plot(k_sample_400/2/np.pi,gamma_sample_400,linewidth=5,label='$m_i/m_e = 400$')
    ax.set_xlim(0.0,)
    ax.set_ylim(0,0.016)
    ax.grid()
    ax.set_xlabel(r'$k/2 \pi \quad [\lambda_{De}^{-1}]$',fontsize=26)
    ...
    fig = plt.figure(figsize=(8,6))
    ax = fig.add_axes(axpos)
    ax.plot(k_sample_25/2/np.pi,omega_sample_25,linewidth=5,label='$m_i/m_e = 25$')
    ax.plot(k_sample_100/2/np.pi,omega_sample_100,linewidth=5,label='$m_i/m_e = 100$')
    ax.plot(k_sample_400/2/np.pi,omega_sample_400,linewidth=5,label='$m_i/m_e = 400$')
    ax.set_ylim(0,0.23)
    ax.set_xlim()
    ax.grid()
    ax.set_xlabel(r'$k/2 \pi \quad [\lambda_{De}^{-1}]$',fontsize=26)
    ...
    fig = plt.figure(figsize=(8,6))
    ax = fig.add_axes(axpos)
    ax.plot(k_sample_25/2/np.pi,gamma_sample_25/k_sample_25,linewidth=5,label='$m_i/m_e = 25$')
    ax.plot(k_sample_100/2/np.pi,gamma_sample_100/k_sample_100,linewidth=5,label='$m_i/m_e = 100$')
    ax.plot(k_sample_400/2/np.pi,gamma_sample_400/k_sample_400,linewidth=5,label='$m_i/m_e = 400$')
    ax.grid()
    ax.set_xlim(0,)
    ax.set_xlabel(r'$k/2 \pi \quad  [\lambda_{De}^{-1}]$',fontsize=26)
    ...
    ax.plot(k_sample_25/2/np.pi,omega_sample_25/k_sample_25,linewidth=5,label='$m_i/m_e = 25$')
    ax.plot(k_sample_100/2/np.pi,omega_sample_100/k_sample_100,linewidth=5,label='$m_i/m_e = 100$')
    ax.plot(k_sample_400/2/np.pi,omega_sample_400/k_sample_400,linewidth=5,label='$m_i/m_e = 400$')
    ax.grid()
    ax.set_xlim(0,)
    ax.set_xlabel(r'$k/2 \pi \quad [\lambda_{De}^{-1}]$',fontsize=26)
