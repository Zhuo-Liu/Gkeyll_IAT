...
def mass25():
    ...
    ######### Field Energy #######
    fieldEnergy1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/fieldEnergy.txt')
    time_fieldEnergy1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/fieldEnergy_time.txt')
    fieldEnergy3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/fieldEnergy.txt')
    time_fieldEnergy3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/fieldEnergy_time.txt')
    ...
    Iontemp1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/ion_intM2Thermal.txt')
    time_Iontemp1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/ion_intM2Thermal_time.txt')
    Iontemp3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/ion_intM2Thermal.txt')
    time_Iontemp3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/ion_intM2Thermal_time.txt')
    ...
    current1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/elc_intM1i.txt')*2
    time_current1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/elc_intM1i_time.txt')
    current3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/elc_intM1i.txt')*2
    time_current3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/elc_intM1i_time.txt')
