...
def mass25():
    ...
    ######### Field Energy #######
    fieldEnergy1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/fieldEnergy.txt')
    time_fieldEnergy1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/fieldEnergy_time.txt')
    fieldEnergy3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/fieldEnergy.txt')
    time_fieldEnergy3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/fieldEnergy_time.txt')
    fieldEnergy3_1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-1/saved_data/fieldEnergy.txt')/2
    time_fieldEnergy3_1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-1/saved_data/fieldEnergy_time.txt')
    fieldEnergy3_2 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/fieldEnergy.txt')
    time_fieldEnergy3_2 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/fieldEnergy_time.txt')
    ...
    Iontemp1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/ion_intM2Thermal.txt')
    time_Iontemp1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/ion_intM2Thermal_time.txt')
    Iontemp3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/ion_intM2Thermal.txt')
    time_Iontemp3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/ion_intM2Thermal_time.txt')
    Iontemp3_1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-1/saved_data/ion_intM2Thermal.txt')
    time_Iontemp3_1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-1/saved_data/ion_intM2Thermal_time.txt')
    Iontemp3_2 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/ion_intM2Thermal.txt')
    time_Iontemp3_2 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/ion_intM2Thermal_time.txt')
    ...
    current1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/elc_intM1i.txt')*2
    time_current1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/1/saved_data/elc_intM1i_time.txt')
    current3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/elc_intM1i.txt')*2
    time_current3 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3/saved_data/elc_intM1i_time.txt')
    current3_1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-1/saved_data/elc_intM1i.txt')
    time_current3_1 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-1/saved_data/elc_intM1i_time.txt')
    current3_2 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/elc_intM1i.txt')*2
    time_current3_2 = np.loadtxt('./Diagnostics/local/Cori/mass25/rescheck/3-2/saved_data/elc_intM1i_time.txt')
    ...
    axs[0,0].plot(time_fieldEnergy3_2[:],fieldEnergy3_2[:],label='#3-2',linewidth=5)
    ...
    axs[0,1].plot(time_Iontemp3_2[:400],Iontemp3_2[:400]/Iontemp3_2[0],label='#3-2',linewidth=5)
    ...
    axs[1,0].plot(time_current3_2[:400],current3_2[:400]/0.02,label='#3-2',linewidth=5)
    ...
    axs[1,1].plot(time_current3_2[9:401],nu_eff3_2[8:400],label='#3-2',linewidth=5)
